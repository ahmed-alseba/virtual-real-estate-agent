...
#define PORT "4544"  // the port users will be connecting to
...
int main(void)
{
	...
	int sellerCPrice = 0;
	int sellerCFootage = 0;
	int sellerDPrice = 0;
	int sellerDFootage = 0;
	...
	cout << "The Agent2 has TCP port " << PORT << " and IP address " << inet_ntoa(*addr_list[0]) << " for Phase 1 part 1\n";
	...
	{  // main accept() loop
		...
		if (!fork()) // this is the child process
		{
			...
			if (sellerCount == 1)
				agentOutput.open("agentSellerCInfo.txt");
			else if (sellerCount == 2)
				agentOutput.open("agentSellerDInfo.txt");
			...
			if (sellerCount == 1)
				cout << "Received house information from SellerC\n";
			else if (sellerCount == 2)
				cout << "Received house information from SellerD\n";
	...
	ifstream sellerFile;
	sellerFile.open("agentSellerCInfo.txt");
	string temp;
	getline(sellerFile, temp);
	sellerCPrice = atoi(temp.c_str());
	getline(sellerFile, temp);
	sellerCFootage = atoi(temp.c_str());
	sellerFile.close();

	sellerFile.open("agentSellerDInfo.txt");
	getline(sellerFile, temp);
	sellerDPrice = atoi(temp.c_str());
	getline(sellerFile, temp);
	sellerDFootage = atoi(temp.c_str());
	sellerFile.close();

	cout << "End of Phase 1 part 1 for Agent2\n";
	...
	for (int i = 1; i <= 5; i++)
	{
		...
		cout << "The Agent2 has UDP port " << agentPort << " and IP address " << inet_ntoa(*addr_list[0]) << " for Phase 1 part 2\n";

		cout << "Agent2 has sent \"" << pack << "\" to Buyer" << i << "\n";
		freeaddrinfo(servinfo2);
		close(sockfd2);
	}
	cout << "End of Phase 1 part 2 for Agent2\n";
	
	//Part 3---------------------------------------------------------------------------------------------
	//---------------------------------------------------------------------------------------------------

	cout << "The Agent2 has TCP port " << PORT << " and IP address " << inet_ntoa(*addr_list[0]) << " for Phase 1 part 3\n";
	...
	{  // main accept() loop
		...
		if (!fork()) // this is the child process
		{
			...
			//Saving child process results into a file for access by parent
			if (buyerCount == 1)
				agentOutputP3.open("agent2Buyer1Info.txt");
			else if (buyerCount == 2)
				agentOutputP3.open("agent2Buyer2Info.txt");
			else if (buyerCount == 3)
				agentOutputP3.open("agent2Buyer3Info.txt");
			else if (buyerCount == 4)
				agentOutputP3.open("agent2Buyer4Info.txt");
			else if (buyerCount == 5)
				agentOutputP3.open("agent2Buyer5Info.txt");
			...
			if (buyerCount == 1)
				cout << "Agent2 receives the offer from Buyer1\n";
			else if (buyerCount == 2)
				cout << "Agent2 receives the offer from Buyer2\n";
			else if (buyerCount == 3)
				cout << "Agent2 receives the offer from Buyer3\n";
			else if (buyerCount == 4)
				cout << "Agent2 receives the offer from Buyer4\n";
			else if (buyerCount == 5)
				cout << "Agent2 receives the offer from Buyer5\n";
	...
	cout << "End of Phase 1 part 3 for Agent2\n";
	//Part 4---------------------------------------------------------------------------------------------
	//---------------------------------------------------------------------------------------------------
	...
	for (int i = 1; i <= 5; i++)
	{
		...
		if (i == 1)fileName = "agent2Buyer1Info.txt"; else if (i == 2)fileName = "agent2Buyer2Info.txt";  else if (i == 3)fileName = "agent2Buyer3Info.txt";
		else if (i == 4)fileName = "agent2Buyer4Info.txt";  else if (i == 5)fileName = "agent2Buyer5Info.txt";
	...
	for (int i = 3; i <= 4; i++)
	{
		...
		cout << "The Agent2 has TCP port " << agentPort << " and IP address " << agentIP << " for Phase 1 part 4\n";
		...
		if (i == 1)
			cout << "Agent2 has sent the result to SellerA\n";
		else if (i == 2)
			cout << "Agent2 has sent the result to SellerB\n";
		else if (i == 3)
			cout << "Agent2 has sent the result to SellerC\n";
		else if (i == 4)
			cout << "Agent2 has sent the result to SellerD\n";
	...
	for (int i = 1; i <= 5; i++)
	{
		...
		if (houseABuyer == i)continue; else if (houseBBuyer == i)continue; else if (houseCBuyer == i)a = "SellerC";
		else if (houseDBuyer == i)a = "SellerD"; else a = "NAK";
		...
		cout << "Agent2 has TCP port " << agentPort << " and IP address " << agentIP << " for Phase 1 part 4\n";
		...
		if (i == 1)
			cout << "Agent2 has sent the result to Buyer1\n";
		else if (i == 2)
			cout << "Agent2 has sent the result to Buyer2\n";
		else if (i == 3)
			cout << "Agent2 has sent the result to Buyer3\n";
		else if (i == 4)
			cout << "Agent2 has sent the result to Buyer4\n";
		else if (i == 5)
			cout << "Agent2 has sent the result to Buyer5\n";

		cout << "End of Phase 1 part 4 for Agent2\n";
