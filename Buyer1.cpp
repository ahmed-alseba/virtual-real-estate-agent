...
#define PORT "22144"  // the port users will be connecting to
...
#define PORT4 "4644" // the port client will be connecting to 
...
int main(void)
{
	...
	cout << "The Buyer1 has UDP port " << PORT << " and IP address " << inet_ntoa(*addr_list[0]) << " for Phase 1 part 2\n";
	...
	cout << "End of Phase 1 part 2 for Buyer1\n";
	...
	cout << "The Buyer1 has TCP port " << buyerPort << " and IP address " << buyerIP << " for Phase 1 part 3\n";
	...
	if (nums != 0)
	{
		...
		cout << "Buyer1 has sent " << bta.str().c_str() << " to Agent1\n";
	}
	else
	{
		...
		cout << "Buyer1 has sent NAK to Agent1\n";
	}
	...
	if (nums != 0)
	{
		...
		cout << "Buyer1 has sent " << bta.str().c_str() << " to Agent2\n";
	}
	else
	{
		if (send(sockfdP3, "NAK\0", strlen("NAK\0"), 0) == -1)
		...
		cout << "Buyer1 has sent NAK to Agent2\n";
	}

	close(sockfdP3);

	cout << "End of Phase 1 part 3 for Buyer1\n";
	...
	cout << "Buyer1 has TCP port " << PORT4 << " and IP address " << inet_ntoa(*addr_list[0]) << " for Phase 1 part 4\n";
	if (nums == 0)
	{
		cout << "NAK\n";
		cout << "End of Phase 1 part 4 for Buyer1\n";
		exit(0);
	}
