...
#define PORT "4544" // the port client will be connecting to  
#define PORT4 "4244" // the port client will be connecting to  
#define BACKLOG 7
int main()
{
	ifstream sellerFile;
	sellerFile.open("sellerC.txt");
	int listingPrice = 0;
	int squareFootage = 0;
	...
	cout << "SellerC has TCP port " << sellerPort << " and IP address " << sellerIP << " for Phase 1 part 1\n";
	cout << "SellerC is now connected to the Agent2\n";
	...
	cout << "SellerC has sent list price of " << listingPrice << " and square footage of " << squareFootage << " to the agent\n";

	close(sockfd);
	cout << "End of Phase 1 part 1 for SellerC\n";
	...
	cout << "SellerC has TCP port " << PORT4 << " and IP address " << inet_ntoa(*addr_list[0]) << " for Phase 1 part 4\n";
	...
	{  // main accept() loop
		...
		if (new_fd == -1) {
			...
			cout << "End of Phase 1 part 4 for SellerC\n";
			close(new_fd);
