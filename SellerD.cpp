...
#define PORT4 "4344" // the port client will be connecting to  
#define BACKLOG 7
int main()
{
	ifstream sellerFile;
	sellerFile.open("sellerD.txt");
	int listingPrice = 0;
	int squareFootage = 0;
	...
	cout << "SellerD has TCP port " << sellerPort << " and IP address " << sellerIP << " for Phase 1 part 1\n";
	cout << "SellerD is now connected to the Agent2\n";
	...
	cout << "SellerD has sent list price of " << listingPrice << " and square footage of " << squareFootage << " to the agent\n";

	close(sockfd);
	cout << "End of Phase 1 part 1 for SellerD\n";
	...
	cout << "SellerD has TCP port " << PORT4 << " and IP address " << inet_ntoa(*addr_list[0]) << " for Phase 1 part 4\n";
	...
	{  // main accept() loop
		...
		if (new_fd == -1) {
			...
			cout << "End of Phase 1 part 4 for SellerD\n";
			close(new_fd);
